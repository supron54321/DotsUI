...
namespace DotsUI.Core
{
    ...
    /// <summary>
    /// This class is a copy of original unity parent system, with original components replaced for better performance.
    /// Original unity parent system requires LocalToWorld and LocalToParent components.
    /// These components add huge overhead, because of LocalToParentSystem execution.
    /// Unity.Transforms.ParentSystem is overriden by WriteGroup over Child component.
    /// </summary>
    public abstract class RectTransformParentSystem : JobComponentSystem
    {
